...
function pageYomTov2() {
  return [
    ...
    serviceRow("7:10 PM", [h("מִנְחָה"), e(" — brief; Yom Tov transitioning into "), h("שַׁבָּת")]),
    serviceRow("7:45 PM", [h("קַבָּלַת שַׁבָּת"), e(" / "), h("מַעֲרִיב"), e(" — "), h("שַׁבָּת"), e(" "), h("קִדּוּשׁ"), e(" (not weekday Yom Tov "), h("קִדּוּשׁ"), e(")")]),
    spacer(100),
    sectionLabel("TORAH READING & PRAYER NOTES", BLUE_LIGHT),
    spacer(60),
    torahBox([
...
function pageCholHamoed() {
  return [
    ...
    spacer(60),
    serviceRow("8:00 AM", [h("שַׁחֲרִית"), e(" — full "), h("הַלֵּל"), e("; Torah reading (4 "), h("עוֹלִים"), e(" only); no "), h("תַּחֲנוּן")]),
    serviceRow("7:10 PM", [h("מִנְחָה")]),
    serviceRow("7:45 PM", [h("מַעֲרִיב"), e(" — "), h("סְפִירַת הָעֹמֶר"), e(" aloud after "), h("צֵאת הַכּוֹכָבִים"), e(" ("), e(Z.cholhamoed.tzait), e(")")]),
    spacer(100),
...
function pageErevShevii() {
  return [
    ...
    spacer(60),
    serviceRow("8:00 AM", [h("שַׁחֲרִית"), e(" — full "), h("הַלֵּל"), e("; Torah reading (4 "), h("עוֹלִים"), e(")")]),
    serviceRow("7:10 PM", [h("מִנְחָה")]),
    serviceRow("7:45 PM", [h("מַעֲרִיב"), e(" / "), h("קִדּוּשׁ"), e(" — "), h("שְׁבִיעִי שֶׁל פֶּסַח"), e(" begins")]),
    spacer(100),
